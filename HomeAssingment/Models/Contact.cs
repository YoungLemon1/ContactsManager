...
namespace HomeAssignment.Models
{
    public class Contact
    {
        ...
        [RegularExpression("[A-Za-z\\s\\-\\']{2,}", ErrorMessage = "First name should be at least 2 letters long")]
        public string FirstName { get; set; }
        [Required(ErrorMessage = "Last Name is Required")]
        [RegularExpression("[A-Za-z\\s\\-\\']{2,}", ErrorMessage = "Last name should be at least 2 letters long")]
